...
class AuthorsLoginTest(AuthorsBaseTest):
    def test_if_is_able_to_Login(self):
        ...
        self.get_by_placeholder(body, 'Digite seu usuário').send_keys("TOLO")
    ...
    def test_login_authenticate_if_is_invalid_credentials(self):
        ...
        self.get_by_placeholder(body, 'Digite seu usuário').send_keys("False")
        ...
        self.assertIn('Usuário e/ou senha incorretos', body.text)
